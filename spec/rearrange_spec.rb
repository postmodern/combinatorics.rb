...
include Combinatorics::Rearrange

describe 'Rearrange' do
  describe 'rearrange' do
    it 'should return [[]] for rearrange(nil, 0).to_a' do
      rearrange(nil, 0).to_a == [[]]
    end

    it 'should return [[]] for rearrange([], 0).to_a' do
      rearrange([], 0).to_a == [[]]
    end

    it 'should return [[]] for rearrange([1], 0).to_a' do
      rearrange([1], 0).to_a == [[]]
    end

    it 'should return [[1]] for rearrange([1], 1).to_a' do
      rearrange([1], 1).to_a == [[1]]
    end

    it 'should return [[1], [2]] for rearrange([1, 2], 1).to_a' do
      rearrange([1, 2], 1).to_a == [[1], [2]]
    end
